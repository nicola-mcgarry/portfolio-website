...
const Projects = () => {
    ...
    return(
        <div id="projects" className="container d-flex flex-column justify-content-center mt-5 ">
            <div className='row d-flex justify-content-evenly  me-2 ms-2'>
                <h1>Personal Projects</h1>
                <p>Projects I've coded and designed</p>
                    <div className='col project p-2 mb-3 pb-3 me-1'>
            ...
            <div className='row d-flex justify-content-around mt-5 me-2 ms-2'>
